...
export interface Env {
  ...
  // Fenêtre de transition pour la PWA et l'APK 1.0.97 qui déclarent encore
  // calendar-events-v1. Seul l'ensemble exact de scopes de ce profil est
  // accepté. ISO-8601, fail-closed, plafond codé au 31 octobre 2026.
  GOOGLE_OAUTH_PREVIOUS_COMPAT_UNTIL?: string
