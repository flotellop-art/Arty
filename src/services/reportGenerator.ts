...
body{font-family:'Inter',sans-serif;font-weight:300;background:#F5F0E8;color:#2C2622;line-height:1.6;position:relative}
body::before{content:'';position:fixed;top:0;left:0;right:0;height:4px;background:linear-gradient(90deg,#B87743,#96643A);z-index:100}
.page{max-width:800px;margin:0 auto;padding:2rem 1.5rem}
.header{background:linear-gradient(145deg,#2C2622 0%,#3a3330 50%,#2C2622 100%);color:#F5F0E8;border-radius:1.5rem;padding:2.5rem;margin-bottom:2rem;position:relative;overflow:hidden;box-shadow:0 8px 28px rgba(44,38,34,0.18),0 2px 6px rgba(44,38,34,0.08);border-left:6px solid #B87743}
.header::before{content:'';position:absolute;top:0;left:0;width:6px;height:100%;background:linear-gradient(180deg,#B87743,#C9A87C);border-radius:3px}
.header::after{content:'';position:absolute;top:-50%;right:-10%;width:300px;height:300px;background:radial-gradient(circle,rgba(184,119,67,0.10),transparent 70%);border-radius:50%}
...
.header .logo{font-size:0.6rem;text-transform:uppercase;letter-spacing:0.2em;color:#C9A87C;font-weight:700;margin-bottom:0.75rem}
.content{font-size:0.9rem}
.section-card{background:white;border-radius:12px;box-shadow:0 4px 16px rgba(44,38,34,0.08);padding:1.5rem 2rem;margin:1.5rem 0}
h2{font-family:'Lora',serif;font-size:1.3rem;color:#2C2622;margin:2rem 0 1rem;padding-bottom:0.5rem;padding-left:0.75rem;border-bottom:2px solid rgba(184,119,67,0.2);border-left:4px solid #B87743}
.section-card h2{margin-top:0}
h3{font-family:'Lora',serif;font-size:1.05rem;color:#96643A;margin:1.5rem 0 0.75rem}
p{margin:0.75rem 0}
strong{font-weight:600;color:#2C2622}
em{color:#96643A;font-style:normal;font-weight:500}
a{color:#96643A;cursor:pointer;text-decoration:underline}
a:hover{color:#B87743}
pre,code{background:#2C2622;color:#F5F0E8;border-radius:6px;padding:0.2em 0.5em;font-family:monospace;font-size:0.85em}
...
thead{background:#3a3330;color:#F5F0E8}
th{padding:0.7rem 1rem;text-align:left;font-size:0.65rem;text-transform:uppercase;letter-spacing:0.08em;font-weight:600;border-left:2px solid #B87743}
...
blockquote{background:linear-gradient(135deg,#F5F0E8,#ece7df);border-left:4px solid #B87743;border-radius:0 1rem 1rem 0;padding:1.25rem 1.5rem;margin:1.25rem 0;font-family:'Lora',serif;font-style:italic}
ul,ol{margin:0.75rem 0;padding-left:0;list-style:none}
li{display:flex;gap:0.5rem;margin:0.4rem 0}
li::before{content:'●';color:#B87743;font-size:0.5rem;margin-top:0.55rem;flex-shrink:0}
...
.card-accent{background:linear-gradient(135deg,#B87743,#96643A);color:#F5F0E8;border-radius:1rem;padding:1.5rem;margin:0.75rem 0;box-shadow:0 4px 16px rgba(184,119,67,0.2);position:relative;overflow:hidden}
...
.card-dark{background:linear-gradient(145deg,#2C2622,#3a3330);color:#F5F0E8;border-radius:1rem;padding:1.5rem;margin:0.75rem 0;position:relative}
.card-dark::after{content:'';position:absolute;bottom:0;left:0;width:100%;height:3px;background:linear-gradient(90deg,#B87743,transparent)}
.big-number{font-size:2.5rem;font-weight:700;font-family:'Lora',serif;color:#96643A;line-height:1}
...
.badge-accent{background:#B87743;color:#F5F0E8}
...
.divider-accent{height:3px;background:linear-gradient(90deg,#B87743,#C9A87C,transparent);border-radius:2px;margin:1.25rem 0}
...
.chapter{background:linear-gradient(145deg,#2C2622,#3a3330);color:#F5F0E8;border-radius:1rem;padding:1.5rem 1.75rem;margin:2rem 0 1rem;position:relative;overflow:hidden}
.chapter::before{content:'';position:absolute;top:0;left:0;width:4px;height:100%;background:linear-gradient(180deg,#B87743,#C9A87C)}
.chapter-number{font-size:0.55rem;text-transform:uppercase;letter-spacing:0.2em;color:#C9A87C;font-weight:700}
...
.progress-fill{height:100%;background:linear-gradient(90deg,#B87743,#C9A87C);border-radius:4px}
...
.metric-value{font-weight:600;font-family:'Lora',serif;color:#2C2622}
...
.pdf-btn{background:#B87743}
.pdf-btn:hover{background:#96643A}
@media print{
