...
body{font-family:'Inter',sans-serif;font-weight:300;background:#F5F0E8;color:#2C2622;line-height:1.6}
.page{max-width:800px;margin:0 auto;padding:2rem 1.5rem}
.header{background:linear-gradient(145deg,#2C2622,#3a3330);color:#F5F0E8;border-radius:1.5rem;padding:2.5rem;margin-bottom:2rem;position:relative;overflow:hidden}
.header::before{content:'';position:absolute;top:0;left:0;width:6px;height:100%;background:linear-gradient(180deg,#B8743D,#C9A87C);border-radius:3px}
.header::after{content:'';position:absolute;top:-50%;right:-10%;width:300px;height:300px;background:radial-gradient(circle,rgba(184,116,61,0.08),transparent 70%);border-radius:50%}
...
h2{font-family:'Lora',serif;font-size:1.3rem;color:#2C2622;margin:2rem 0 1rem;padding-bottom:0.5rem;border-bottom:2px solid rgba(184,116,61,0.2)}
...
tr:hover{background:rgba(184,116,61,0.03)}
blockquote{background:linear-gradient(135deg,#F5F0E8,#ece7df);border-left:4px solid #B8743D;border-radius:0 1rem 1rem 0;padding:1.25rem 1.5rem;margin:1.25rem 0;font-family:'Lora',serif;font-style:italic}
ul,ol{margin:0.75rem 0;padding-left:0;list-style:none}
li{display:flex;gap:0.5rem;margin:0.4rem 0}
li::before{content:'●';color:#B8743D;font-size:0.5rem;margin-top:0.55rem;flex-shrink:0}
...
.card-accent{background:linear-gradient(135deg,#B8743D,#9A6234);color:#F5F0E8;border-radius:1rem;padding:1.5rem;margin:0.75rem 0;box-shadow:0 4px 16px rgba(184,116,61,0.2);position:relative;overflow:hidden}
...
.card-dark::after{content:'';position:absolute;bottom:0;left:0;width:100%;height:3px;background:linear-gradient(90deg,#B8743D,transparent)}
...
.badge-accent{background:#B8743D;color:#F5F0E8}
...
.divider-accent{height:3px;background:linear-gradient(90deg,#B8743D,#C9A87C,transparent);border-radius:2px;margin:1.25rem 0}
...
.chapter::before{content:'';position:absolute;top:0;left:0;width:4px;height:100%;background:linear-gradient(180deg,#B8743D,#C9A87C)}
...
.progress-fill{height:100%;background:linear-gradient(90deg,#B8743D,#C9A87C);border-radius:4px}
