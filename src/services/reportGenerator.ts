...
.header h1 { font-family: 'Lora', serif; font-size: 2rem; font-weight: 700; margin-bottom: 0.5rem; }
.header .meta { font-size: 0.85rem; opacity: 0.6; }
.header .logo { font-size: 0.65rem; text-transform: uppercase; letter-spacing: 0.2em; color: #E05510; font-weight: 700; margin-bottom: 0.75rem; }
.content { font-size: 0.95rem; }
h2 { font-family: 'Lora', serif; font-size: 1.4rem; color: #1E1A14; margin: 2rem 0 1rem; padding-bottom: 0.5rem; border-bottom: 2px solid rgba(224,85,16,0.2); }
h3 { font-family: 'Lora', serif; font-size: 1.1rem; color: #E05510; margin: 1.5rem 0 0.75rem; }
h4 { font-size: 0.8rem; text-transform: uppercase; letter-spacing: 0.1em; opacity: 0.5; font-weight: 700; margin: 1rem 0 0.5rem; }
p { margin: 0.75rem 0; }
strong { font-weight: 600; color: #1E1A14; }
em { color: #E05510; font-style: normal; font-weight: 500; }
a { color: #E05510; text-decoration: underline; text-decoration-color: rgba(224,85,16,0.3); }
a:hover { text-decoration-color: #E05510; }
...
th { padding: 0.75rem 1rem; text-align: left; font-size: 0.7rem; text-transform: uppercase; letter-spacing: 0.08em; font-weight: 600; }
td { padding: 0.75rem 1rem; border-bottom: 1px solid rgba(30,26,20,0.06); }
...
li::before { content: '●'; color: #E05510; font-size: 0.6rem; margin-top: 0.5rem; flex-shrink: 0; }
hr { border: none; height: 1px; background: linear-gradient(to right, transparent, rgba(30,26,20,0.15), transparent); margin: 2rem 0; }
code { background: rgba(224,85,16,0.1); color: #E05510; padding: 0.15rem 0.4rem; border-radius: 0.3rem; font-size: 0.85rem; }
pre { background: #1E1A14; color: #F5F0E8; border-radius: 1rem; padding: 1.25rem; overflow-x: auto; margin: 1rem 0; }
...
.card-accent { background: linear-gradient(135deg, #E05510, #c44a0e, #a83a0a); color: #F5F0E8; border-radius: 1rem; padding: 1.5rem; margin: 0.75rem 0; box-shadow: 0 4px 16px rgba(224,85,16,0.3); position: relative; overflow: hidden; }
...
.caption { font-size: 0.75rem; color: #9ca3af; margin-top: 0.35rem; }
.badge { display: inline-block; padding: 0.2rem 0.65rem; border-radius: 2rem; font-size: 0.65rem; font-weight: 700; letter-spacing: 0.04em; text-transform: uppercase; }
...
.chapter-title { font-size: 1.3rem; font-family: 'Lora', serif; font-weight: 700; margin-top: 0.3rem; }
.chapter-subtitle { font-size: 0.8rem; opacity: 0.5; margin-top: 0.3rem; }
...
.footer { margin-top: 3rem; padding-top: 1.5rem; border-top: 2px solid rgba(30,26,20,0.06); text-align: center; font-size: 0.75rem; color: #9ca3af; }
.footer strong { color: #E05510; }
@media print { body { background: white; } .page { padding: 1rem; } .header { break-inside: avoid; } }
@media (max-width: 640px) { .grid-2, .grid-3 { grid-template-columns: 1fr; } .big-number { font-size: 2rem; } .header h1 { font-size: 1.5rem; } }
</style>
</head>
<body>
<div class="page">
...
<div class="footer">
<strong>Façades Pollet</strong> — Artisan façadier à Valence (26) — 📞 04 75 XX XX XX — facadespollet.fr
</div>
</div>
</body>
</html>`
...
export function generateReportUrl(title: string, htmlContent: string): string {
  const fullHtml = REPORT_TEMPLATE(title, htmlContent)
  const blob = new Blob([fullHtml], { type: 'text/html' })
