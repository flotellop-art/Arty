...
export const TEXT_MODELS: readonly TextModel[] = [
  ...
  { provider: 'gemini', modelId: TEXT_DEFAULTS.geminiResearch, costKey: 'gemini-flash-3.6', label: 'Gemini 3.6 Flash', family: 'gemini-flash', trial: false },
  { provider: 'gemini', modelId: TEXT_DEFAULTS.geminiChat, costKey: 'gemini-flash-pro', label: 'Gemini 3.5 Flash', family: 'gemini-flash', trial: false },
  { provider: 'gemini', modelId: 'gemini-3.5-flash-lite', costKey: 'gemini-flash-lite-3.5', label: 'Gemini 3.5 Flash Lite', family: 'gemini-flash', trial: false },
  { provider: 'gemini', modelId: 'gemini-3.1-flash-lite', costKey: 'gemini-flash-lite-3.1', label: 'Gemini 3.1 Flash Lite', family: 'gemini-flash', trial: false },
  ...
  { provider: 'mistral', modelId: TEXT_DEFAULTS.mistralChat, costKey: 'mistral-medium', label: 'Mistral Medium', family: 'mistral-medium', trial: false },
  ...
  { provider: 'openai', modelId: 'gpt-5-mini', costKey: 'gpt-5-mini', label: 'GPT-5 Mini', family: 'gpt-mini', trial: false },
