...
export const TEXT_MODELS: readonly TextModel[] = [
  ...
  { provider: 'gemini', modelId: 'gemini-3.8-flash', responseIds: ['gemini-3.8-flash-001'], costKey: 'gemini-flash-3.8', label: 'Gemini 3.8 Flash', family: 'gemini-flash', trial: true },
  { provider: 'gemini', modelId: 'gemini-3.1-pro-preview', costKey: 'gemini-3.1-pro-preview', label: 'Gemini 3.1 Pro (Preview)', family: 'gemini-pro', trial: false },
  ...
  { provider: 'mistral', modelId: 'mistral-large-latest', responseIds: ['mistral-large-2512'], costKey: 'mistral-large', label: 'Mistral Large', family: 'mistral-medium', trial: false },
