...
describe('workspace entry static dependency boundary', () => {
  it.each(['src/main.tsx', 'src/screens/landing.tsx', 'src/components/share/SharedConversationView.tsx', 'src/services/workspaceWriter/control.ts', 'src/services/workspaceWriter/upgrade.ts', 'src/components/workspace/ColdWorkspaceUpgrade.tsx', 'src/components/workspace/ColdErasureRecovery.tsx', 'src/services/accountErasureReceipt.ts', 'src/services/workspaceWriter/erasure.ts'])('%s does not statically import private identity/crypto/stores', entry => {
