...
export function OnboardingChoice({
  ...
  return (
    <main
      className="auth-viewport-scroll keyboard-aware bg-theme-bg text-theme-ink flex flex-col items-center px-6"
    >
        ...
        {mode === 'choice' && (
          <>
            ...
            <div className="mt-8 space-y-4">
              <p className="rounded-xl bg-theme-surface px-3 py-2 text-center font-sans text-[11px] leading-relaxed text-theme-muted">
              ...
              />
              {!busy && (
                <p className="mt-2 text-center font-sans text-[11px] text-theme-muted">
