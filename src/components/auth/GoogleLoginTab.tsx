  ...
  return (
    <div className="space-y-4">
      <button
        ...
        disabled={loading}
        className="w-full flex items-center justify-center gap-3 py-2.5 rounded-xl border border-theme-border bg-theme-surface hover:bg-theme-ink/[0.03] transition-colors disabled:opacity-40"
      >
        ...
        <span className="text-sm font-medium text-theme-ink/80">{t('login.google.signIn')}</span>
      </button>
